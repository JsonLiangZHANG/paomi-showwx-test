...
stareal
    .controller("PSearchController", function ($scope, $api, $stateParams, $timeout, $lazyLoader,localStorageService) {
        // 展现热词
        $scope.hwf = true;
        // // 加载热词
        ...
        $scope.history_list = JSON.parse(localStorageService.get("plist"));
        ...
        $scope.hws = function(keyword){
            ...
            localStorageService.set("plist",JSON.stringify($scope.history));
        };
        $scope.history_list = JSON.parse(localStorageService.get("plist"));
        //回车搜索
        ...
        $scope.dele = function (id) {
            ...
            localStorageService.set("plist",JSON.stringify($scope.history_list));
        }
